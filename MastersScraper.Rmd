...
if (year == 2007 || year == 2008 || year == 2009 || year == 2010 || year == 2011 || year == 2012 || year == 2014 || year == 2015 || year == 2016 || year == 2017 || year == 2018 || year == 2021){
  tourney = ".eoff.t020"}
...
```{r}
write.csv(past5_data, file = "2022Masters_past5.csv") 
```
...
## Create csv file
```{r}
write.csv(all_data, file = "C:\\Users\\milness\\Desktop\\Machine Learning\\Final Project\\2022Masters_pred_data.csv") 
```
