...
# pgaFinal[order(pgaFinal$top_10_prob, decreasing = FALSE),]

# FinalTestDataSub2 <- subset(pgaFinal, select =  c(year, player_name, top_10_prob))

# FinalTestDataSub2[order(FinalTestDataSub2$top_10_prob, decreasing = FALSE),]
